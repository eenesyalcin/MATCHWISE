...
{
    public class InterviewWriteRepository : WriteRepository<Interview>, IInterviewWriteRepository
    {
        public InterviewWriteRepository(MatchwiseServerDbContext context) : base(context)
        {
        }
    }
}
